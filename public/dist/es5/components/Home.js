...
var Footer = require("./presentation/index").Footer;
var Search = _interopRequire(require("./containers/Search"));

var Results = _interopRequire(require("./containers/Results"));
